...
def getNewMoonDay(k, timeZone):
    ...
    JdNew = Jd1 + C1 - deltat
    result = YNT(JdNew + 0.5 + timeZone / 24)
    return result
...
if __name__ == "__main__":
    ...
    #kq = Solar2Lunar(25, 7, 2025) #day la ngay 1/6 am lich nhuan cua nam 2025
    thangnhuan = None
    if kq[3] == 0:
        thangnhuan = ""
    else:
    ...
    print(
        ...
        + str(kq[2])
        + " ("
        + CanChi(currentDay, currentMonth, currentYear)
        + ")",
    )
    ...
    print(
        ...
        + "-"
        + CanChi(currentDay, currentMonth, currentYear),
        "là ngày: ", Lunar2Solar(1, 6, 2025, 1, 7), " dương lịch")
