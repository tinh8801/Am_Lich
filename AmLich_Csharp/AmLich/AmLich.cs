...
namespace AmLich
{
    public static class LunarYearTools
    {
        ...
        public static long getNewMoonDay(long k, int timeZone)
        {
            ...
            JdNew = Jd1 + C1 - deltat;
            //Console.Write("JdNew: ");
            //Console.WriteLine(JdNew);
            double result = JdNew + 0.5 + timeZone / 24.0;
            //Console.Write("getNewMoonDay: ");
         ...
         * Algorithm from: "Astronomical Algorithms" by Jean Meeus, 1998
         */
        public static long getSunLongitude(double jdn, int timeZone)
        {
            double T, T2, dr, M, L0, DL, L, omega;
            T = (jdn - 2451545.5 - timeZone/24.0) / 36525.0; // Time in Julian centuries from 2000-01-01 12:00:00 GMT
            T2 = T * T;
            ...
            double result = L/PI*6;
           	//Console.Write("getSunLongitude: ");
            //Console.WriteLine(result);
            return (long)result;
        }
        ...
        /*public static long getNewMoonDay(long k, int timeZone)
        {
            long result = NewMoon(k) + 0.5 + timeZone / 24.0;
            return result;
        }*/
        ...
        public static long getLeapMonthOffset(long a11, int timeZone)
        {
            ...
            //Console.Write("getLeapMonthOffset: ");
