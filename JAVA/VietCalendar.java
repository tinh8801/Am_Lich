...
public class VietCalendar {
    ...
    public static void main(String[] args) {
        double TZ = 7.0;
        int start = jdFromDate(1, 1, 2025);
        int step = 1;
        int count = -1;
		int[] kq = convertSolar2Lunar(25, 7, 2025, TZ);
		System.out.println("(25-07-2025) là  ngày "+kq[0]+"-"+kq[1]+"-"+kq[2]+" (nhuận: "+kq[3]+") âm lịch");
        while (count++ < 365) {
